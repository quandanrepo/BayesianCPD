...
# 1) Unknown Mean, Known Sigma
# 2) Known Mean, Unknown Sigma
# 3) Unknown Mean, Unknown Sigma
...
if (cpd_test==1){
...
}else if(cpd_test==2){ #Known Mean, Unknown Sigma
  # Use approximation using samples from prior, reversible jump, and analytical
  ...
  dscaleinvchi <- function(x,df_para,scale_para,log){
    if (log=="TRUE") {
